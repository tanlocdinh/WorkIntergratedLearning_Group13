...
- Building a font collection that maps font properties to inferred roles (e.g., heading levels and body text) to assist in sectioning and content classification.
  ...
  for idx, page in enumerate(pdf, start=1):
    ...
    text_blocks = extract_text_blocks(page, table_bboxes, header_threshold, footer_threshold)
  ...
  all_blocks = sorted(all_blocks, key=lambda block: (block.page, block.bbox[1], block.bbox[0]))
